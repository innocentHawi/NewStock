        ...
        <aside class="bg-gray-800 w-64">
            ...
            <nav class="text-gray-300 mt-20">
                <ul class="space-y-2">                
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.markets')); ?>" class="flex items-center px-6 py-3 hover:bg-gray-700">
                            <span class="mr-3">Markets</span>
                        </a>
                    </li>
                    <!-- Add Investor Balance -->
                    <li>
                        <a href="<?php echo e(route('admin.users')); ?>" class="flex items-center px-6 py-3 hover:bg-gray-700">
...
</html><?php /**PATH C:\Users\user\Documents\GitHub\NewStock\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>