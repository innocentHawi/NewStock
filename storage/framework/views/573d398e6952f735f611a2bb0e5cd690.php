...
<body class="bg-gradient-to-r from-purple-700 to-blue-600 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
        ...
        <p class="text-center text-sm text-gray-600 mt-4">Already have an account? <a href="<?php echo e(route('login.dashboard')); ?>" class="text-purple-700 hover:underline">Log in</a></p>
    </div>
</body>

</html><?php /**PATH C:\Users\user\Documents\GitHub\NewStock\resources\views/register.blade.php ENDPATH**/ ?>