...
<body>
    <div class= "header">
        ...
        <div class="navigation">
            ...
            <a href="<?php echo e(route('register.dashboard')); ?>" class="btn btn-info">Register</a>
            <a href="<?php echo e(route('login.dashboard')); ?>" class="btn btn-info">Log in</a>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\user\Documents\GitHub\NewStock\resources\views/landingpage.blade.php ENDPATH**/ ?>